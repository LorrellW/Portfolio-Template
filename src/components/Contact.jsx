...
export const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        emailjs
            .send(
                'service_k9e6gqb', // Replace with your actual Service ID
                'template_avvrlgm', // Replace with your actual Template ID
                {
                    name: form.name,
                    email: form.email,
                    message: form.message,
                },
                'Bjd7H0f21jcPtUazU' // Replace with your actual Public Key
            )
            .then(
                (result) => {
